...
export function YuniLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="95" height="81" viewBox="0 0 95 81" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g filter="url(#yuni-logo-filter-a)">
        <path
          ...
          fill="url(#yuni-logo-paint-a)"
          fillOpacity="0.59"
        />
      </g>
      <g filter="url(#yuni-logo-filter-b)">
        <path
      ...
      <defs>
        ...
        <linearGradient id="yuni-logo-paint-a" x1="8.4534" y1="40.6182" x2="84.4534" y2="40.6182" gradientUnits="userSpaceOnUse">
          <stop stopColor="#CE48F6" />
          <stop offset="1" stopColor="#32FAF5" />
        </linearGradient>
        <linearGradient id="yuni-logo-paint-b" x1="39" y1="27" x2="49.5" y2="75" gradientUnits="userSpaceOnUse">
