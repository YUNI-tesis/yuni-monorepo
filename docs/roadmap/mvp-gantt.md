...
- Implementado parcialmente: `18` y `24B` para llamada privada MVP.
- Pendiente: estructura final de producto, contexto/documentos reales, share con identidad, actividad/progreso, publico y hardening.
...
| P1 | `19-private-conversations-api` | API/conversacion | share identity contract acordado | conversaciones por owner/shared/public identity |
...
- Tercer hito: creator comparte por link/email o grant y usuario compartido ve el avatar.
