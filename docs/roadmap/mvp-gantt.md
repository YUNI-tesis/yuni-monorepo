...
- Implementado: planes `00` a `13`, incluido el baseline privado de `12A`, segun `docs/plan-prompts/README.md`.
...
- Implementado parcialmente: `24-openai-adapter-prompt-builder` para titulos de conversaciones.
...
- Primer hito: Dashboard y Mis avatares permiten navegar propios/compartidos. Estado: cerrado para el baseline privado; falta el refactor final a Inicio + Mis avatares.
- Segundo hito: Interact abre llamada contextual con historial preparado. Estado: cerrado para owner/shared autenticado.
- Tercer hito: creator comparte por grant y el usuario compartido puede llamar y recuperar su propio historial. Estado: cerrado para grants.
